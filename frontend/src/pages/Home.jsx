...
const Home = () => {
  return (
          ...
          <div>
            <div className='lg:w-[570px]'>
              ...
              <p className='text__para'>
               lorem34wvwrnvpwnrpvnnrievvvvvvvvvvvvvqknwkerfwqmfipmwrfnvnv,
               qwnfewnf,qwmfmemf jwqnrfnwrenfwenfnwfnkwmff,wnfpwnpfnpwnfpnwfnwnfpwnfrfiwrnf
               ,wkfnwrnfnfrwnpinpirnvnrvrnvnrpnnnn
              </p>
   ...
   <ul className="pl-4">
    ...
    <li className="text__para">2.Search for your physician here, and contact thei office.</li>
  ...
  <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
     ...
     p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
      ...
      <span className='w-5 h-5 lg:w-w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rounded py-1 px-[6px]
      lg:py-3 lg:px-[9px]'>
     <img src={videoIcon}/>
      </span>
      </div>
